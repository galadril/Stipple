...
// STIPPLE_ASSERT is a development-time contract check. It compiles out entirely
...
#ifdef NDEBUG
#    define STIPPLE_ASSERT(cond) (static_cast<void>(0))
#else
#    define STIPPLE_ASSERT(cond) assert(cond)
#endif
