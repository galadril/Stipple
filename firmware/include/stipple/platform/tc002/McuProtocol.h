...
/// visualiser came and went. This is the one command STIPPLE writes beyond the
...
/// then stopped: the vendor application had enabled it before STIPPLE ever ran,
/// STIPPLE inherited a microphone it never asked for, and a reboot took it away.
...
///
/// The commands STIPPLE sends are byte literals lifted from captures, because a
